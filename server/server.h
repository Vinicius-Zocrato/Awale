...
static void play_move(ServerMatch *matches, Client *sender, int relatifMove, int *actualMatches);
static void change_client_profile(Client *sender, const char *new_profile);
static void view_client_profile(Client *clients, Client sender, int actual, const char *name);
